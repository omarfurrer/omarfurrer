<h3 class="tab-head"><?php _e( 'Image Caption Hover', 'image-caption-hover' ); ?></h3>
	<div class="tab-content">
		...
		<table class="widefat">
	        ...
	        <tr>
	            ...
	            <td><input type="text" class="widefat imagewidth"></td>
	            <td><?php _e( 'Height eg: 100px or 50%', 'image-caption-hover' ); ?></td>
	            <td><input type="text" class="widefat imageheight"></td>
	        </tr>
		</table>
	...
	<table class="widefat">
		...
		<tr>
			...
			<td><input class="captionbg colorpicker" data-alpha="true" type="text" value=""></td>
			<td><?php _e( 'Caption Text Color', 'image-caption-hover' ); ?></td>
			<td><input class="captioncolor colorpicker" data-alpha="true" type="text" value=""></td>
		</tr>
		<tr>
