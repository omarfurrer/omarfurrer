...
(function(f,k){"object"===typeof exports?module.exports=k(require("./punycode"),require("./IPv6"),require("./SecondLevelDomains")):"function"===typeof define&&define.amd?define(["./punycode","./IPv6","./SecondLevelDomains"],k):f.URI=k(f.punycode,f.IPv6,f.SecondLevelDomains,f)})(this,function(f,k,g,r){function d(a,b){if(!(this instanceof d))return new d(a,b);void 0===a&&(a="undefined"!==typeof location?location.href+"":"");this.href(a);return void 0!==b?this.absoluteTo(b):this}function p(a){return a.replace(/([.*+?^=!:${}()|[\]\/\\])/g,
    ...
    return!0}function x(a){return escape(a)}function y(a){return encodeURIComponent(a).replace(/[!'()*]/g,x).replace(/\*/g,"%2A")}var B=r&&r.URI;d.version="1.12.1";var e=d.prototype,q=Object.prototype.hasOwnProperty;d._parts=function(){return{protocol:null,username:null,password:null,hostname:null,urn:null,port:null,path:null,query:null,fragment:null,duplicateQueryParameters:d.duplicateQueryParameters,escapeQuerySpace:d.escapeQuerySpace}};d.duplicateQueryParameters=!1;d.escapeQuerySpace=!0;d.protocol_expression=
    ...
    var n={encode:"encode",decode:"decode"},u,t=function(a,b){return function(c){return d[b](c+"").replace(d.characters[a][b].expression,function(c){return d.characters[a][b].map[c]})}};for(u in n)d[u+"PathSegment"]=t("pathname",n[u]);d.encodeReserved=t("reserved","encode");d.parse=function(a,b){var c;b||(b={});c=a.indexOf("#");-1<c&&(b.fragment=a.substring(c+1)||null,a=a.substring(0,c));c=a.indexOf("?");-1<c&&(b.query=a.substring(c+1)||null,a=a.substring(0,c));"//"===a.substring(0,2)?(b.protocol=null,
        ...
        null):a.indexOf(":")!==a.lastIndexOf(":")?(b.hostname=a.substring(0,c)||null,b.port=null):(d=a.substring(0,c).split(":"),b.hostname=d[0]||null,b.port=d[1]||null);b.hostname&&"/"!==a.substring(c).charAt(0)&&(c++,a="/"+a);return a.substring(c)||"/"};d.parseAuthority=function(a,b){a=d.parseUserinfo(a,b);return d.parseHost(a,b)};d.parseUserinfo=function(a,b){var c=a.indexOf("/"),m=-1<c?a.lastIndexOf("@",c):a.indexOf("@");-1<m&&(-1===c||m<c)?(c=a.substring(0,m).split(":"),b.username=c[0]?d.decode(c[0]):
        null,c.shift(),b.password=c[0]?d.decode(c.join(":")):null,a=a.substring(m+1)):(b.username=null,b.password=null);return a};d.parseQuery=function(a,b){if(!a)return{};a=a.replace(/&+/g,"&").replace(/^\?*&*|&+$/g,"");if(!a)return{};for(var c={},m=a.split("&"),e=m.length,h,f,l=0;l<e;l++)h=m[l].split("="),f=d.decodeQuery(h.shift(),b),h=h.length?d.decodeQuery(h.join("="),b):null,c[f]?("string"===typeof c[f]&&(c[f]=[c[f]]),c[f].push(h)):c[f]=h;return c};d.build=function(a){var b="";a.protocol&&(b+=a.protocol+
        ":");a.urn||!b&&!a.hostname||(b+="//");b+=d.buildAuthority(a)||"";"string"===typeof a.path&&("/"!==a.path.charAt(0)&&"string"===typeof a.hostname&&(b+="/"),b+=a.path);"string"===typeof a.query&&a.query&&(b+="?"+a.query);"string"===typeof a.fragment&&a.fragment&&(b+="#"+a.fragment);return b};d.buildHost=function(a){var b="";if(a.hostname)d.ip6_expression.test(a.hostname)?b=a.port?b+("["+a.hostname+"]:"+a.port):b+a.hostname:(b+=a.hostname,a.port&&(b+=":"+a.port));else return"";return b};d.buildAuthority=
        function(a){return d.buildUserinfo(a)+d.buildHost(a)};d.buildUserinfo=function(a){var b="";a.username&&(b+=d.encode(a.username),a.password&&(b+=":"+d.encode(a.password)),b+="@");return b};d.buildQuery=function(a,b,c){var m="",e,h,f,l;for(h in a)if(q.call(a,h)&&h)if(s(a[h]))for(e={},f=0,l=a[h].length;f<l;f++)void 0!==a[h][f]&&void 0===e[a[h][f]+""]&&(m+="&"+d.buildQueryParameter(h,a[h][f],c),!0!==b&&(e[a[h][f]+""]=!0));else void 0!==a[h]&&(m+="&"+d.buildQueryParameter(h,a[h],c));return m.substring(1)};
    d.buildQueryParameter=function(a,b,c){return d.encodeQuery(a,c)+(null!==b?"="+d.encodeQuery(b,c):"")};d.addQuery=function(a,b,c){if("object"===typeof b)for(var m in b)q.call(b,m)&&d.addQuery(a,m,b[m]);else if("string"===typeof b)void 0===a[b]?a[b]=c:("string"===typeof a[b]&&(a[b]=[a[b]]),s(c)||(c=[c]),a[b]=a[b].concat(c));else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");};d.removeQuery=function(a,b,c){var m;if(s(b))for(c=0,m=b.length;c<m;c++)a[b[c]]=void 0;
    else if("object"===typeof b)for(m in b)q.call(b,m)&&d.removeQuery(a,m,b[m]);else if("string"===typeof b)if(void 0!==c)if(a[b]===c)a[b]=void 0;else{if(s(a[b])){m=a[b];var e={},h,f;if(s(c))for(h=0,f=c.length;h<f;h++)e[c[h]]=!0;else e[c]=!0;h=0;for(f=m.length;h<f;h++)void 0!==e[m[h]]&&(m.splice(h,1),f--,h--);a[b]=m}}else a[b]=void 0;else throw new TypeError("URI.addQuery() accepts an object, string as the first parameter");};d.hasQuery=function(a,b,c,m){if("object"===typeof b){for(var e in b)if(q.call(b,
    ...
    }};d.commonPath=function(a,b){var c=Math.min(a.length,b.length),d;for(d=0;d<c;d++)if(a.charAt(d)!==b.charAt(d)){d--;break}if(1>d)return a.charAt(0)===b.charAt(0)&&"/"===a.charAt(0)?"/":"";if("/"!==a.charAt(d)||"/"!==b.charAt(d))d=a.substring(0,d).lastIndexOf("/");return a.substring(0,d+1)};d.withinString=function(a,b,c){c||(c={});var m=c.start||d.findUri.start,e=c.end||d.findUri.end,h=c.trim||d.findUri.trim,f=/[a-z0-9-]=["']?$/i;for(m.lastIndex=0;;){var l=m.exec(a);if(!l)break;l=l.index;if(c.ignoreHtml){var g=
        a.slice(Math.max(l-3,0),l);if(g&&f.test(g))continue}var g=l+a.slice(l).search(e),n=a.slice(l,g).replace(h,"");c.ignore&&c.ignore.test(n)||(g=l+n.length,n=b(n,l,g,a),a=a.slice(0,l)+n+a.slice(g),m.lastIndex=l+n.length)}m.lastIndex=0;return a};d.ensureValidHostname=function(a){if(a.match(d.invalid_hostname_characters)){if(!f)throw new TypeError("Hostname '"+a+"' contains characters other than [A-Z0-9.-] and Punycode.js is not available");if(f.toASCII(a).match(d.invalid_hostname_characters))throw new TypeError("Hostname '"+
